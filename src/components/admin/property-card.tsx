...
export function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    ...
    >
      <Card className="bg-card border-border hover:border-primary/40 hover:shadow-lg py-0 transition-all duration-200 h-full flex flex-col justify-between overflow-hidden relative">
        <CardContent className="p-5 sm:p-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2 pt-2 border-t border-border text-center">
            <div className="p-2 rounded-lg bg-muted/30 border border-border/40 space-y-1">
              ...
              <div className="text-sm font-bold text-foreground">{floors}</div>
            </div>
            ...
            <div className="p-2 rounded-lg bg-muted/30 border border-border/40 space-y-1">
              ...
              <div className="text-sm font-bold text-foreground">{rooms}</div>
            </div>
        ...
        {/* Footer Link Prompt */}
        <div className="px-5 sm:px-6 py-2.5 sm:py-4 bg-muted/20 border-t border-border/40 flex items-center justify-between text-xs font-semibold text-primary hover:bg-primary/5 transition-colors">
